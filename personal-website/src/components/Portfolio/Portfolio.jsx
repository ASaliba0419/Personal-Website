      ...
      <a href="https://github.com/ASaliba0419" target='_blank'>
        ...
        <div className='port-info'>
          <a href="https://asaliba0419.github.io/Slurm-Factory/" target="_blank">
            ...
            <img id='port-pic' src="https://res.cloudinary.com/dtp9f7dv2/image/upload/v1635177261/Portfolio/projects/HTbyPryLTH_s5viuf.gif" alt="FuturamaAPI" />
          </a>
          <p id='port-info-text'>
          ...
          <a href="https://overwatch-characters.netlify.app/" target='_blank'>
            ...
            <img id='port-pic' src="https://res.cloudinary.com/dtp9f7dv2/image/upload/v1635179962/Portfolio/projects/YR8zs5YqAK_adbn5f.gif" alt="OverwatchAPI" />
          </a>
          <p id='port-info-text'>
          ...
          <a href="https://boomroasted.netlify.app/" target='_blank'>
            ...
            <img id='port-pic' src="https://res.cloudinary.com/dtp9f7dv2/image/upload/v1635181756/Portfolio/projects/TvaQ00ffGq_dfvcg1.gif" alt="Boom!Roasted" />
          </a>
          <p id='port-info-text'>
          ...
          <a href="https://habibiheart-breaker.netlify.app" target='_blank'>
            ...
            <img id='port-pic' src="https://res.cloudinary.com/dtp9f7dv2/image/upload/v1635182350/Portfolio/projects/d0dwKlqD7t_ogagxh.gif" alt="HabibiHeart-Breaker" />
          </a>
          <p id='port-info-text'>
